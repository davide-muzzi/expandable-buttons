...
class ExpandableButton(QWidget):
    def __init__(self, label, description, parent):
        ...
        self.button.setStyleSheet("font-size: 16px; padding: 10px 15px 10px 15px;")  # Adjust button label padding: top, right, bottom, left  # Change button text font size here
        self.button.clicked.connect(self.toggle_description)

        self.desc_box = QTextEdit(description)
        self.desc_box.setStyleSheet("font-size: 14px; padding: 10px 15px 10px 15px;")  # Adjust expanded text padding: top, right, bottom, left  # Change description font size here
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        headline.setStyleSheet("font-size: 24px; font-weight: bold; padding: 10px 20px 5px 20px;")  # Adjust headline padding: top, right, bottom, left  # Change font size/weight here
        ...
        intro_text.setStyleSheet("font-size: 13px; padding: 5px 20px 20px 20px;")  # Adjust intro text padding: top, right, bottom, left  # Change intro text font size here  # Change placeholder text here
